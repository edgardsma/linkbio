 ...
 */
export async function requerirAutenticacao(request) {
...
/**
 * Função para verificar se o usuário é agência ou admin
 */
export async function isAgencyOrAdmin(request) {
  const user = await obterUsuarioAutenticado(request)
...
export const getSession = obterSessao
export const getAuthenticatedUser = obterUsuarioAutenticado
export const requireAuth = requerirAutenticacao
