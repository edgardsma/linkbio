...
// Informações públicas dos planos (independente do Stripe estar configurado)
const PUBLIC_PLANS = {
  free: {
    name: 'FREE',
  ...
  starter: {
    ...
    cta: 'Assinar Starter',
    get stripePriceId() { return process.env.STRIPE_PRICE_STARTER_MONTHLY || null },
    get stripePriceIdAnnual() { return process.env.STRIPE_PRICE_STARTER_ANNUAL || null },
  },
  pro: {
    name: 'PRO',
    ...
    cta: 'Assinar PRO',
    get stripePriceId() { return process.env.STRIPE_PRICE_PRO_MONTHLY || null },
    get stripePriceIdAnnual() { return process.env.STRIPE_PRICE_PRO_ANNUAL || null },
  },
  premium: {
    name: 'PREMIUM',
    ...
    cta: 'Assinar PREMIUM',
    get stripePriceId() { return process.env.STRIPE_PRICE_PREMIUM_MONTHLY || null },
    get stripePriceIdAnnual() { return process.env.STRIPE_PRICE_PREMIUM_ANNUAL || null },
  },
}
